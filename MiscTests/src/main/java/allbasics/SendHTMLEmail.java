...
public class SendHTMLEmail {
	public static void main(String[] arg) {
		...
		/*
		 * final String user = "vikas.uni@gmail.com"; // username on mail server final
		...
		/*
		 * String toAddress =
		 * "vikas.gond@infogain.com,Sanjeev@infogain.com,Nidhi.Kulkarni@infogain.com,Muskan.Jaiswal@infogain.com,"
		...
		try {
			 ...
			 * InternetAddress.parse("abc@def.com"), InternetAddress.parse("ghi@abc.com")};
