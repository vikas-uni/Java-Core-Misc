...
//Date currentDate = new SimpleDateFormat("MM-dd-yyyy").parse(new Date().toString());
			...
			/*
			 * DatatypeFactory df = DatatypeFactory.newInstance(); GregorianCalendar gc =
			 * new GregorianCalendar(); gc.setTimeInMillis(currentDate.getTime());
			 * XMLGregorianCalendar xMLGregorianCalendar = df .newXMLGregorianCalendar(gc);
			 * 
			 * System.out.println(currentDate);
			 * 
			 * System.out.println("�ut date######################:::::"+xMLGregorianCalendar
			 * .toString());
			 */
			/*
			 * System.out.println("�ut date######################:::::"+new Date());
			 * 
			 * 
			 * DateFormat datef = new SimpleDateFormat("MM-dd-yyyy"); String s =
			 * datef.format(new Date()); Date curdate=datef.parse(s);
			 * 
			 * // Date curdate = new SimpleDateFormat("MM-DD-YYYY").parse("04-07-2015");
			 * 
			 * System.out.println("�ut date######################:::::"+curdate);
			 * 
			 * 
			 * 
			 * DatatypeFactory df = DatatypeFactory.newInstance(); GregorianCalendar gc =
			 * new GregorianCalendar(); gc.setTimeInMillis(curdate.getTime());
			 * XMLGregorianCalendar xMLGregorianCalendar = df .newXMLGregorianCalendar(gc);
			 * 
			 * System.out.println("�ut date######################:::::"+xMLGregorianCalendar
			 * .toString());
