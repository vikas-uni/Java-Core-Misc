...
public class SimpleClientSocketExample
{
    public static void main( String[] args )
    {
        ...
        try
        {
            ...
            Socket socket = new Socket(server , 80 ); // if you want to define a different port, you can do so by adding a colon followed by the port number, for example: :8080
